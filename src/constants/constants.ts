...
export enum EBizLogicMsg {
    ...
    EXAMPLE_SAGA_WRONG_DATA_STRUCTURE = 'Example saga wrong data structure',
    LOGIN_WRONG_DATA_STRUCTURE = 'Login wrong data structure',
    REGISTER_WRONG_DATA_STRUCTURE = 'Register wrong data structure',
    ...
    FACEBOOK_LOGIN_RESULT_TYPE_INVALID = 'Facebook loginResult has returned type neither success nor cancel',
    ...
    NOT_CONFORM_TO_API_RESPONSE_SERVER_STRUCTURE = 'Not conform to response server structure',
    ...
    API_EXAMPLE_SAGA_SUCCESS = 'Get example saga success',
    API_LOGIN_SUCCESS = 'Login success',
    API_REGISTER_SUCCESS = 'Register success',
    API_ME_SUCCESS = 'Get my user info success',
    API_ME_WRONG_DATA_STRUCTURE = 'Get my user info wrong data structure',
    CANCELED_REQUEST = 'Canceled request',
    WRONG_DATA_STRUCTURE = 'Wrong data structure',
    PSEUDO_BACKEND_SUCCESS = 'Pseudo backend success',
